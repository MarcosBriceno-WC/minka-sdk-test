 ...
 */
export type BridgeSecurityRule = BridgeOauthSecurityRule | BridgeHeaderSecurityRule;
/**
...
/**
 * Security rules used to define header-based authentication
 * by setting custom headers on requests to the bridge.
 */
export type BridgeHeaderSecurityRule = {
    schema: 'header';
    key: string;
    value: InlineSecretReference;
};
/**
 ...
 */
export declare const BLOCKED_BRIDGE_HEADERS: Set<string>;
/**
 ...
 */
export declare const WARNED_BRIDGE_HEADERS: Set<string>;
/**
