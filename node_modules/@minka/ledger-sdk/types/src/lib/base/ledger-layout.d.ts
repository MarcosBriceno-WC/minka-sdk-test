...
import { Ledger } from '../records/ledger/ledger';
import { LedgerAnchor } from '../records/ledger-anchor';
...
export type LayoutRecordsMap = Partial<{
    ...
    [LayoutRecord.Anchor]: BaseRecordValue<LedgerAnchor>[];
...
export type AnchorLayoutValue = {
    record: LayoutRecord.Anchor;
    values: LayoutRecordValues<LedgerAnchor>;
};
export type SignerProofLayoutValue = {
    record: LayoutRecord.SignerProof;
    values: LayoutRecordValues<LedgerProof>;
};
export type LayoutValue = SchemaLayoutValue | BridgeLayoutValue | WalletLayoutValue | CircleLayoutValue | PolicyLayoutValue | IntentLayoutValue | SignerLayoutValue | AnchorLayoutValue | DomainLayoutValue | EffectLayoutValue | SymbolLayoutValue | LedgerLayoutValue | SignerProofLayoutValue;
/**
