...
import { BridgeActivationOptions, LedgerBridge, LedgerIdentifier, LedgerPagedList, LedgerRecord } from "../../../types/src";
...
import { BridgeListParams } from './bridge-list-params';
/**
...
export declare class BridgeClient extends BaseClient {
     ...
     */
    read(id: LedgerIdentifier, options?: BaseReadOptions): Promise<BridgeResponse>;
    /**
     ...
     */
    list(params?: BridgeListParams): Promise<BridgesResponse>;
    /**
     * Initializes a builder instance that supports chaining to make it
     * easier to work with ledger records. You can pass the record
     * payload to this method to use as initial content, this is useful
     ...
     * @returns a builder instance
     */
    drop(id?: LedgerIdentifier): DropRecordBuilder<LedgerBridge, import("../../../types/src").LedgerMeta>;
}
